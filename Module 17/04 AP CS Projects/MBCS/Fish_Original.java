...
public class Fish_Original implements Locatable
{
  ...
  // constructors and related helper methods
     ...
     **/
    public Fish_Original(Environment env, Location loc)
    {
     ...
     **/
    public Fish_Original(Environment env, Location loc, Direction dir)
    {
     ...
     **/
    public Fish_Original(Environment env, Location loc, Direction dir, Color col)
    {
